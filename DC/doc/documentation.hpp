 ...
 *
 * This is the documentation of the programming project for the exercises in the Lecture 'Databases Implementation Techniques' (DB2) in summer term 2015. You can find general information about the lecture <a href="http://wwwiti.cs.uni-magdeburg.de/iti_db/lehre/db2/2015/">here</a>.
 *
 ...
 * The task is to implement compression techniques in our framework. We provide a set of classes as presetting, where you have to include an implementation w.r.t. an interface. You can download the sources <a href="http://wwwiti.cs.uni-magdeburg.de/iti_db/lehre/db2/2015/programming_task/db2_programming_project_SoSe2015.zip">here</a>. A set of unit tests will help you during the development process to identify errors. The same unit tests will be used at the end of the term to validate your solution. A working implementation is a necessary prerequisite to participate in the exam!
...
All compression techniques are explained in the lecture. You can find the slides <a href="http://wwwiti.cs.uni-magdeburg.de/iti_db/lehre/db2/2015/slides/teil2.pdf">here</a>.
 *
...
Please register your team until the <b>30.04.2015</b> via email to: andreas.meister@iti.cs.uni-magdeburg.de, subject: DB2-2015 Programmierprojekt Anmeldung.
Content: For each team member, we need to know the name, matrikel number, and email adress.

Solutions are to be submitted via email to: andreas.meister@iti.cs.uni-magdeburg.de, subject: DB2-2015 Programmierprojekt Abgabe. The deadline is the 03.07.2015 at 23:59 o'clock. Note that the deadline is strict, there will be <b>no</b> deadline extension.
...
@code
cd db2_programming_project_SoSe2015
make
make documentation
make run
@endcode
